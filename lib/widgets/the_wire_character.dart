...
import 'package:api_test/data/wire_api_service.dart';
...
class TheWireCharacter extends StatefulWidget {
  ...
  const TheWireCharacter({super.key, required this.characters});
...
class _TheWireCharacterState extends State<TheWireCharacter> {
  ...
  Future<void> fetchData() async {
    ...
    final wireApiService = WireApiService();
    _characters=await wireApiService.fetchData();
        setState(() {
          _isLoading = false;
        });
                      ...
                      child: ListTile(
                        ...
                        subtitle: Text(
                          ...
                          style: GoogleFonts.amethysta(
                            textStyle: TextStyle(color: ColorManager.whiteGreen),
                          ),
                        ),
                        onTap: () {
                          Navigator.push(
